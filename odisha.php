...
$statescount = count($coranalive[22]['districtData']);
...
<td style="background: #ffe493"><?php  echo $coranalive[22]['districtData'][$i]['district']. "<br>"; ?></td>
   <td style="background: #9ED9CCFF;"><?php  echo $coranalive[22]['districtData'][$i]['confirmed']. "<br>";  ?></td>
    <td style="background: #fc95c6;"><?php echo $coranalive[22]['districtData'][$i]['active'] . "<br>"; ?></td>
    <td style="background: #88d28b;"><?php echo $coranalive[22]['districtData'][$i]['recovered'] . "<br>"; ?></td>
    <td style="background: #fd99a1;"><?php  echo $coranalive[22]['districtData'][$i]['deceased'] . "<br>";  ?></td>
